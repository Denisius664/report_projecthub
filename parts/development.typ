...
#figure(
  ...
  caption: "Взаимодействие между компонентами"
...
Был разработан интерфейс для загрузки, скачивания, поиска и фильтрации проектов; удобный и интуитивно понятный веб-интерфейс. Реализованы функции поиска, фильтрации;
...
- Поиск и фильтрация: По полям (название, описание, теги, предметная область);
