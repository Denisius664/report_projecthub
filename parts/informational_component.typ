...
- Файлы проектов (текст, PDF, Word, Excel, JSON), загружаемые пользователями.
...
Далее представлена инфологическая модель разработанной базы данных (Рис. 1).
...
При построении логической модели базы данных (Рис. 2) были добавлены уникальные ключи для каждой сущности. Все таблицы соответствуют 3НФ (третьей нормальной форме):
...
Для физической модели базы данных была выбрана СУБД PostgreSQL, обоснование выбора которой будет представлена в следующих главах. Схема модели представлена ниже (Рис. 3).
